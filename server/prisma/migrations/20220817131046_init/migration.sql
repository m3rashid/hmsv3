...
CREATE TABLE "Profile" (
    ...
    CONSTRAINT "Profile_pkey" PRIMARY KEY ("authId")
);
...
-- AddForeignKey
ALTER TABLE "Appointment" ADD CONSTRAINT "Appointment_doctorId_fkey" FOREIGN KEY ("doctorId") REFERENCES "Profile"("authId") ON DELETE RESTRICT ON UPDATE CASCADE;
